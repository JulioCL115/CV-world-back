...
const createCv = async (req, res) => {
    try {
        ...
        const cvCreated = await postCvController(name, image, header, description, experience, education, contact, skils, speakingLanguages, otherInterests, creationDate, views, userId, categoryId, lenguajeId);
